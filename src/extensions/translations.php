...
return [
    ...
    'fr' => [
        ...
        'johannschopplich.content-translator.dialog.import' => 'Les champs de la langue actuelle seront écrasés par le contenu de la langue par défaut ({language}). Les modifications du contenu sont réversibles. Continuer ?',
        'johannschopplich.content-translator.dialog.importFrom' => 'Les champs de la langue actuelle seront écrasés par le contenu de <strong>{language}</strong>. Les modifications du contenu sont réversibles. Continuer ?',
        'johannschopplich.content-translator.dialog.translate' => 'Le contenu de la langue actuelle sera traduit en <strong>{language}</strong>. Les modifications du contenu sont réversibles. Continuer ?',
    ...
    'nl' => [
        ...
        'johannschopplich.content-translator.bulkTranslate' => '{language} → Alle talen',
        ...
        'johannschopplich.content-translator.dialog.import' => 'De velden van de huidige taal worden overschreven met de inhoud van de standaardtaal ({language}). Inhoudswijzigingen zijn omkeerbaar. Doorgaan?',
        'johannschopplich.content-translator.dialog.importFrom' => 'De velden van de huidige taal worden overschreven met de inhoud van <strong>{language}</strong>. Inhoudswijzigingen zijn omkeerbaar. Doorgaan?',
